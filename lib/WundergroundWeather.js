...
WundergroundWeather.prototype = {
	...
	getCurrentWeather: function(callback) {
		...
		request.get(
			'http://api.wunderground.com/api/33c9addcc118e257/conditions/lang:VU/q/zmw:00000.2.48894.json',
	...
	getHourlyWeather: function(callback) {
		...
		request.get(
			'http://api.wunderground.com/api/33c9addcc118e257/conditions/hourly/lang:VU/q/zmw:00000.2.48894.json',
			function(error, response, body) {
				var jsonBody;
				if (!error && response.statusCode === 200) {
