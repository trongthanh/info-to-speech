...
function composeInfoString(weather) {
	...
	text += 'Outside temperature is ' + weather.getTemperature() +  ' degree Celsius. ';
	text += 'Humidity ' + weather.getHumidity() + ' percent, ';
	text += 'wind speed ' + weather.getWindSpeed() + ' km/h with ';
	text += weather.getMainCondition();
