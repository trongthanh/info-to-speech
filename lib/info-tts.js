...
var Weather = require('./OpenWeather.js');
...
function getCurrentWeather() {
	...
	weather.getCurrentWeather(function() {
		var text = composeInfoString(weather);
...
function composeInfoString(weather) {
	...
	text += 'Outside temperature is ' + weather.temp() +  ' degree Celsius. ';
	text += 'Humidity ' + weather.humidity() + ' percent, ';
	text += 'wind speed ' + weather.windSpeed() + ' km/h with ';
